...
local function DrawBovinelatentSettings()
...
local function DrawBovinecombatSettings()
    bovinecombatModule.DrawSettings();
end
...
local function DrawBovinelatentColorSettings()
...
local function DrawBovinecombatColorSettings()
