...
-- ========================================
-- Press-scale animation (ported from upstream XIUI, tirem/XIUI)
-- Required by modules/hotbar/crossbar.lua for button/trigger press
-- feedback. Uses this fork's existing M.easeOutBack / M.easeOutQuad.
-- ========================================
