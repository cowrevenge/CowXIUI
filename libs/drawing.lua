...
-- ========================================
-- Move Anchor Widget (ported from upstream XIUI, tirem/XIUI)
-- Required by modules/hotbar/display.lua and crossbar.lua for the
-- draggable reposition handle shown while the config menu is open.
-- Depends only on globals already present in this fork: showConfig,
-- ARGBToImGui, and M.GetUIDrawList (all confirmed above).
-- ========================================
