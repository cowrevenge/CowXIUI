...
petbar.Initialize = function(settings)
    ...
    data.bstLabelText = FontManager.create(settings.vitals_font_settings);
    ...
    data.allFonts = {data.nameText, data.distanceText, data.hpText, data.mpText, data.tpText, data.bstTimerText, data.bstLabelText};
...
petbar.UpdateVisuals = function(settings)
    ...
    data.bstLabelText = FontManager.recreate(data.bstLabelText, settings.vitals_font_settings);
...
petbar.Cleanup = function()
    ...
    data.bstLabelText = FontManager.destroy(data.bstLabelText);
